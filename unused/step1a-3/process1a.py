...
class Lgtab(object):
 def __init__(self,data):
  ...
  #if self.dictkey == 'pAyasa': # dbg
  # print "pAyasa: dictlex=",self.dictlex
  # print "pAyasa: dictlex_adj=",self.dictlex_adj
...
def process_record(data,normlex,normerrs):
 ...
 if lexadj in normlex:
  ...
  normlex[lexadj].count = normlex[lexadj].count + 1
