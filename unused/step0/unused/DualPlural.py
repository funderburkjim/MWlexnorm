""" DualPlural.py Sep 27, 2014
 Merge lexicalgrammar0.xml and DualPlural.txt into lexicalgrammar.xml
 
"""
import sys, re,codecs

def lexicalgrammar1(filein,fileout,dpdict):
...
if __name__=="__main__": 
 filein = sys.argv[1] # lexicalgrammar0.xml
 filein1 = sys.argv[2] # DualPlural.txt
 fileout = sys.argv[3] # lexicalgrammar.xml
 dpdict = parse_dualPlural(filein1)
 lexicalgrammar1(filein,fileout,dpdict)
