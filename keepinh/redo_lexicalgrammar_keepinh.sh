...
python lexicalgrammar_dp_keepinh.py ../../mwxml/mw.xml ../step0/DualPlural.txt ../step0/participle.txt lexicalgrammar_keepinh.xml
echo "validating lexicalgrammar.xml with lexicalgrammar.dtd"
python validate.py lexicalgrammar_keepinh.xml ../step0/lexicalgrammar.dtd
