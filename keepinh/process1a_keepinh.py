""" process1a_keepinh.py Jan 29, 2016
 Don't discard inherited lex records
...
def lex_adjust(lex):
 ans = lex
 #ans = re.sub(r'<lex type="inh">.*?</lex>','',ans) Jan 29, 2016
 ans = re.sub(r'<lex type="inh">(.*?)</lex>',r'<lex>\1</lex>',ans)
